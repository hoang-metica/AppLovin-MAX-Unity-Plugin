...
namespace Metica.Ads.IOS
{
    ...
    public class IOSLoadCallback
    {
        ...
        public delegate void OnAdLoadSuccessDelegate(string adUnitId, double revenue, string networkName,
        ...
        private static void OnAdLoadSuccess(string adUnitId, double revenue, string networkName, string placementTag,
            string adFormat, string creativeId, long latency)
        {
