...
namespace Metica
{
    public class MeticaSdk
    {
        ...
        internal static string Version { get => "2.0.0-beta9"; }

        internal static string UserId { get; set; } // TODO: set should become private and require a reinitialization to change user id
